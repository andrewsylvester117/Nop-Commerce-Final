...
namespace Nop.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
		...
		private readonly IThemeModelFactory themeModelFactory;
		...
		{
			String currentTheme = _commonSettings.CurrentTheme;
			var model = themeModelFactory.PrepareCustomerThemeModel(currentTheme);
			_commonSettings.CurrentTheme = model.CurrentTheme;
			return View(model);
		}
