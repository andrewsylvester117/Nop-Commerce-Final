...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<PluginUpdatedEvent>
    {
		...
		//Themes
		public void HandleEvent(EntityInsertedEvent<Theme> eventMessage)
		{
			
		}
		public void HandleEvent(EntityUpdatedEvent<Theme> eventMessage)
		{
			
		}
		public void HandleEvent(EntityDeletedEvent<Theme> eventMessage)
		{
