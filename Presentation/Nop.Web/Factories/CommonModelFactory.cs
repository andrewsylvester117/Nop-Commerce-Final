...
namespace Nop.Web.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
		...
		public virtual ThemeSelectorModel PrepareThemeSelectorModel(String currentTheme)
		{
			var avaliableThemes = new List<ThemeModel>();
			String current = currentTheme;

			avaliableThemes.Add(new ThemeModel("Light"));
			avaliableThemes.Add(new ThemeModel("Dark"));

			var model = new ThemeSelectorModel(current)
			{
